...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR ",
                   ...
                   menu_items={'About': """# This OCR app is created by *Nahid*!"""})
...
background_image_url = "https://wallpapers.com/images/hd/aesthetic-full-moon-jclck9rpwumz6dxh.webp"
setting_bg(background_image_url)


# page set-up
selected = option_menu(None, ["Home","Upload & Extract","Edit"], 
                       icons=["house","cloud-upload",":memo:"],
                       default_index=0,
...
connection = mysql.connector.connect(
    host="localhost",
    user="root",
    password="Nahid123", database="bizcard_easyocr")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def is_duplicate(card_data):
            cursor.execute("SELECT * FROM card_data WHERE company_name = %s AND mobile_number = %s AND email = %s",
